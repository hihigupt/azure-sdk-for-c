...
az_result az_iot_provisioning_client_register_subscribe_topic_filter_get(
...
az_result az_iot_provisioning_register_topic_payload_parse(
    az_iot_provisioning_client const * client,
    az_span received_topic,
    az_span received_payload,
    az_iot_provisioning_register_response * out_response);

// Note: payload may contain JSON-encoded data.
az_result az_iot_provisioning_register_publish_topic_get(
    az_iot_provisioning_client const * client,
    az_span mqtt_topic,
    az_span * out_mqtt_topic);

az_result az_iot_provisioning_get_operation_status_publish_topic_get(
    az_iot_provisioning_client const * client,
    az_span request_id,
    az_span mqtt_topic,
    az_span * out_mqtt_topic);
